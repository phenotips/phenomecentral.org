...
public class createPatientTest extends baseTest implements commonInfoEnums {
    ...
    final viewPatientPage currentPage2 = new viewPatientPage(theDriver); // At some point we need to restart the view patients page.
